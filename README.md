...
В качестве данных использовать полиномы из лабораторной работы 4. Для осуществления арифметических выражениий можно использовать код из лабораторной работы 3.
